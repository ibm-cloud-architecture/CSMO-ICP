## How to import the CSMO Grafana Dashboads
 ...
 2) In the file **ICP 2.1 Performance IBM Provided.json**, find and correct the link to Kibana (`https://<icp_IP_address>:8443/kibana`) or Import the dashboard and follow these instructions for customizing the Link to Kibana from withing the dashboard: [Kibana_Link](Edit_Kibana_Link.md)
